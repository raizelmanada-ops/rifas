    ...
    <main className="min-h-screen pb-12 flex flex-col items-center selection:bg-accent selection:text-black">
      <header className="w-full relative z-10 flex justify-between items-center bg-black border-b border-[#FFD700]/30 shadow-md px-4" style={{ padding: '8px 16px' }}>
        ...
        <div className="flex-1 flex justify-end">
          <a href={`https://wa.me/${whatsappAdmin}?text=Hola,%20quiero%20información%20del%20sorteo`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 bg-[#25D366] text-white px-6 py-3 rounded-full text-lg md:text-xl font-black shadow-[0_0_20px_rgba(37,211,102,0.8)] hover:scale-105 transition-transform border-2 border-white/20">
