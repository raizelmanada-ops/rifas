  ...
  return (
    <main className="min-h-screen pb-12 flex flex-col items-center selection:bg-accent selection:text-black">
      <header className="w-full relative z-10 flex justify-center bg-black border-b border-[#FFD700]/30 shadow-md" style={{ padding: '8px 0' }}>
        ...
        <a href={`https://wa.me/${whatsappAdmin}`} target="_blank" rel="noopener noreferrer" className="absolute right-4 top-1/2 -translate-y-1/2 flex items-center gap-2 bg-[#25D366] text-white px-3 py-1.5 rounded-full text-xs font-bold hover:bg-[#128C7E] transition-colors shadow-lg z-50">
