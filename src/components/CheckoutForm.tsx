    ...
    <div className="glass-panel max-w-lg mx-auto w-full animate-fade-in">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <div className="bg-warning/10 border border-warning/30 rounded-lg p-4 mt-2">
          ...
          <p className="text-xs text-gray-300 mt-1">Al hacer clic en continuar, tendrás 15 minutos para realizar tu pago manual por transferencia (ej. Nequi) y enviar el comprobante, de lo contrario el número se liberará automáticamente.</p>
        </div>
        ...
        <div className="flex gap-4 mt-4">
          ...
          <button 
            ...
            disabled={loading}
          >
            {loading ? "Reservando..." : "Reservar y Ver Pago"}
          </button>
        </div>
      </form>
    </div>
